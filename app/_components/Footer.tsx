  ...
  return (
    <footer className="pt-16 lg:pt-28 pb-16 bg-background-light dark:bg-black text-primary-text-light dark:text-white relative overflow-hidden transition-colors duration-300">
      ...
      <img 
        ...
        className="absolute top-0 right-0 w-1/2 opacity-15 pointer-events-none dark:invert-0 invert" 
      />

      <div className="container mx-auto px-6">
        {/* FAQ Section */}
        <div className="max-w-3xl mx-auto mb-36">
          <h2 className="text-h3 lg:text-h2 font-bold text-center mb-16 text-primary-text-light dark:text-white">Frequently Asked Questions</h2>
          <div className="space-y-4">
            {FAQS.map((faq, i) => (
              ...
              >
                ...
                >
                  <span className="text-h5 font-semibold transition-colors text-primary-text-light dark:text-white hover:text-studio group-hover:text-studio" data-slot="faq-question">{faq.question}</span>
                  <div className="p-2 rounded-full bg-black/5 dark:bg-white/5 group-hover:bg-studio/10 transition-colors">
                    {openIndex === i ? <Minus className="size-5 text-studio" /> : <Plus className="size-5 text-primary-text-light dark:text-white group-hover:text-studio" />}
                  </div>
                </button>
                <AnimatePresence>
                  {openIndex === i && (
                    ...
                    >
                      <p className="pb-9 text-body-md text-subtle-text-light dark:text-subtle-text-dark leading-relaxed">
                        {faq.answer}
                      </p>
                    </motion.div>
                  )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-14 mb-24 border-t border-black/10 dark:border-white/10 pt-20">
          <div className="col-span-1 md:col-span-1 space-y-7">
            <Link href="/" className="inline-block group">
               <FooterLogo className="w-44 text-primary-text-light dark:text-white transition-colors" />
            </Link>
            <p className="text-body-sm text-subtle-text-light dark:text-subtle-text-dark max-w-xs leading-relaxed">
              Train with AI. Cheat on Sales Calls. Close the Deal. 
              The AI-powered sales training and enablement platform.
            </p>
            <div className="flex gap-4">
              <Link href={Y22_URLS.social.twitter} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-black/5 dark:bg-white/5 hover:bg-studio/15 hover:text-studio text-primary-text-light dark:text-white transition-all">
                <Twitter className="size-5" />
              </Link>
              <Link href={Y22_URLS.social.github} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-black/5 dark:bg-white/5 hover:bg-studio/15 hover:text-studio text-primary-text-light dark:text-white transition-all">
                <Github className="size-5" />
              </Link>
              <Link href={Y22_URLS.social.linkedin} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-black/5 dark:bg-white/5 hover:bg-studio/15 hover:text-studio text-primary-text-light dark:text-white transition-all">
                <Linkedin className="size-5" />
              </Link>
              <Link href={Y22_URLS.social.discord} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-black/5 dark:bg-white/5 hover:bg-studio/15 hover:text-studio text-primary-text-light dark:text-white transition-all">
          ...
          <div className="space-y-7">
            <h4 className="text-body-lg font-bold text-primary-text-light dark:text-white">Product</h4>
            <ul className="space-y-5 text-primary-text-light dark:text-primary-text-dark text-body-sm">
          ...
          <div className="space-y-7">
            <h4 className="text-body-lg font-bold text-primary-text-light dark:text-white">Resources</h4>
            <ul className="space-y-5 text-primary-text-light dark:text-primary-text-dark text-body-sm">
          ...
          <div className="space-y-7">
            <h4 className="text-body-lg font-bold text-primary-text-light dark:text-white">Legal</h4>
            <ul className="space-y-5 text-primary-text-light dark:text-primary-text-dark text-body-sm">
        ...
        <div className="text-center pt-10 border-t border-black/5 dark:border-white/5 text-body-xs text-subtle-text-light dark:text-subtle-text-dark opacity-50 mt-12">
